    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0d0221] via-[#1a1629] to-[#0d0221] text-gray-200">
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 py-20 text-center">
        ...
        <div className="mt-20 relative">
          <div className="absolute inset-0 bg-gradient-to-r from-[#ff006e]/20 to-[#00d9ff]/20 blur-3xl rounded-full"></div>
          <div className="relative bg-[#0a0b0f] border border-[#ff006e]/30 rounded-2xl p-8 backdrop-blur">
            <div className="font-mono text-sm space-y-2 text-left max-w-2xl mx-auto">
              <div className="text-[#00d9ff]">$ jvcs init my-project</div>
              <div className="text-[#ffbe0b]">Repository initialized successfully!</div>
              <div className="text-[#00d9ff] mt-3">$ jvcs add .</div>
              <div className="text-[#ffbe0b]">3 files staged</div>
              <div className="text-[#00d9ff] mt-3">$ jvcs commit "Initial commit"</div>
              <div className="text-[#ffbe0b]">Commit created with ID: abc123def456</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="features" className="max-w-6xl mx-auto px-4 sm:px-6 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-[#1a1629]/90 backdrop-blur border border-[#ffbe0b]/30 rounded-xl p-8 hover:shadow-[0_0_30px_rgba(255,190,11,0.15)] transition-all">
            ...
            <p className="text-gray-400">View your contribution streak, activity calendar, and repository statistics all in one place.</p>
          </div>
        </div>
      </section>
      ...
      <section id="installation" className="max-w-6xl mx-auto px-4 sm:px-6 py-20">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-[#1a1629]/90 backdrop-blur border border-[#ff006e]/30 rounded-xl p-8">
            <h3 className="text-2xl font-bold text-[#ff006e] mb-6">Installation</h3>
            <p className="text-gray-400 mb-6">Install JVCS globally using npm and start versioning your code.</p>
            ...
            <div className="space-y-4">
              <div className="relative">
                ...
                <button
                  onClick={() => copyToClipboard("npm install -g jvcs", "install")}
                  className="absolute top-0 right-0 p-2 hover:bg-[#ff006e]/10 rounded transition-colors"
                >
                  {copied === "install" ? <Check className="w-4 h-4 text-[#ffbe0b]" /> : <Copy className="w-4 h-4 text-gray-400" />}
                </button>
              </div>
              ...
              <div className="relative">
                ...
                <button
                  onClick={() => copyToClipboard("jvcs begin", "begin")}
                  className="absolute top-0 right-0 p-2 hover:bg-[#00d9ff]/10 rounded transition-colors"
                >
                  {copied === "begin" ? <Check className="w-4 h-4 text-[#ffbe0b]" /> : <Copy className="w-4 h-4 text-gray-400" />}
                </button>
              </div>
              ...
              <div className="relative">
                ...
                <button
                  onClick={() => copyToClipboard("jvcs init my-project", "init-2")}
                  className="absolute top-0 right-0 p-2 hover:bg-[#ffbe0b]/10 rounded transition-colors"
                >
                  {copied === "init-2" ? <Check className="w-4 h-4 text-[#ffbe0b]" /> : <Copy className="w-4 h-4 text-gray-400" />}
                </button>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#1a1629]/90 backdrop-blur border border-[#00d9ff]/30 rounded-xl p-8">
            <h3 className="text-2xl font-bold text-[#00d9ff] mb-6">Quick Setup</h3>
            
            <div className="space-y-4">
              <div className="flex gap-4">
                <div className="flex-shrink-0 w-8 h-8 rounded-full bg-[#ff006e] flex items-center justify-center font-bold">1</div>
                <div>
                  <p className="font-semibold text-white">Sign Up</p>
                  <p className="text-sm text-gray-400">Create your account on JVCS</p>
                </div>
              </div>

              <div className="flex gap-4">
                <div className="flex-shrink-0 w-8 h-8 rounded-full bg-[#00d9ff] flex items-center justify-center font-bold">2</div>
                <div>
                  <p className="font-semibold text-white">Install CLI</p>
                  <p className="text-sm text-gray-400">npm install -g jvcs</p>
                </div>
              </div>

              <div className="flex gap-4">
                <div className="flex-shrink-0 w-8 h-8 rounded-full bg-[#ffbe0b] flex items-center justify-center font-bold">3</div>
                <div>
                  <p className="font-semibold text-white">Initialize</p>
                  <p className="text-sm text-gray-400">Run jvcs init to start a repo</p>
                </div>
              </div>

              <div className="flex gap-4">
                <div className="flex-shrink-0 w-8 h-8 rounded-full bg-[#ff006e] flex items-center justify-center font-bold">4</div>
                <div>
                  <p className="font-semibold text-white">Start Versioning</p>
                  <p className="text-sm text-gray-400">Add, commit, and push your code</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 py-20 text-center">
        <div className="bg-[#1a1629]/90 backdrop-blur border border-gradient-to-r from-[#ff006e]/50 to-[#00d9ff]/50 rounded-2xl p-12">
          ...
          <p className="text-gray-400 mb-8 max-w-xl mx-auto">
            Join thousands of developers using JVCS. Sign up now and start managing your code with our powerful version control system.
          </p>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-sm text-gray-400">Personal Version Control System for modern developers.</p>
            </div>
