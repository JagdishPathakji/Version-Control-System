            ...
            {activeTab === "overview" && (
              <section className="bg-[#1a1629]/90 backdrop-blur-xl border border-[#ff006e]/30 p-8 shadow-2xl">
                ...
                <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="border border-[#ff006e]/20 bg-[#0d0221]/60 p-5">
                  ...
                  <div className="border border-[#00d9ff]/20 bg-[#0d0221]/60 p-5">
                    <h3 className="font-bold text-gray-100">Insights</h3>
                    <p className="text-gray-400 text-sm mt-2">
                      AI assistant will generate insights here.
                    </p>
                  </div>
                </div>
              </section>
