          ...
          <main className="col-span-12 md:col-span-9 space-y-8">
            ...
            <section className="bg-[#1a1629]/90 backdrop-blur-xl border border-[#00d9ff]/30 rounded-none p-8 shadow-2xl transition-all duration-300">
              <div className="flex items-center justify-between gap-4 mb-6">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="px-4 py-2 bg-[#00d9ff]/20 border border-[#00d9ff]/30 text-sm font-semibold text-gray-200 hover:bg-[#00d9ff]/30 transition-all"
                  >
                    Create Repo
                  </button>
                  <button
                    onClick={() => navigate("/profile")}
                    className="px-4 py-2 bg-[#ff006e]/20 border border-[#ff006e]/30 text-sm font-semibold text-gray-200 hover:bg-[#ff006e]/30 transition-all"
                  >
                    My Profile
                  </button>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-5">
                <div className="p-4 bg-[#0d0221]/60 border border-[#00d9ff]/20">
                  <p className="text-xs text-gray-400">Total Repos</p>
                  <p className="text-2xl font-bold text-gray-100">{userRepo.length}</p>
                </div>

                <div className="p-4 bg-[#0d0221]/60 border border-[#ff006e]/20">
                ...
                <div className="p-4 bg-[#0d0221]/60 border border-[#00d9ff]/20">
                  ...
                  <p className="text-2xl font-bold text-gray-100">{publicRepos.length}</p>
                </div>

                <div className="p-4 bg-[#0d0221]/60 border border-[#ff006e]/20">
                  <p className="text-xs text-gray-400">Public Profiles</p>
                  <p className="text-2xl font-bold text-gray-100">{publicProfiles.length}</p>
                </div>
              </div>
            </section>
