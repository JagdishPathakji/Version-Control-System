...
export default function Documentation({ setIsAuthenticated }: { setIsAuthenticated: (value: boolean) => void }) {
  ...
  const commands = [
    ...
    {
      cmd: "jvcs push",
      desc: "Push local commits to remote storage (currently Google Drive).",
      example: "jvcs push",
          ...
          <div className="lg:col-span-4 space-y-12">
            ...
            <section id="overview" className="scroll-mt-20">
              ...
              <p className="text-gray-300 text-lg mb-4">
                JVCS (Jagdish Version Control System) is a lightweight Git-like CLI tool to manage repositories,
                track changes, commit, push, and collaborate. Designed for simplicity, it works with local
                repositories and cloud storage (Google Drive) for remote sync.
              </p>
            </section>
            ...
            <section id="installation" className="scroll-mt-20">
              ...
              <p className="text-gray-300 mb-4">Install globally or locally for your project:</p>
              ...
              <div className="mb-6">
                ...
                <button
                  ...
                  className="mt-2 p-2 bg-[#ff006e]/20 rounded-lg"
                >
                  {copied === "install-global" ? <Check /> : <Copy />}
                </button>
                <p className="text-gray-400 mt-2">Use anywhere on your system.</p>
              </div>
              ...
              <div className="mb-6">
                ...
                <button
                  ...
                  className="mt-2 p-2 bg-[#00d9ff]/20 rounded-lg"
                >
                  {copied === "install-local" ? <Check /> : <Copy />}
                </button>
                <p className="text-gray-400 mt-2">
                  Use <code>npx jvcs</code> for local commands.
                </p>
              </div>
            </section>
            ...
            <section id="commands" className="scroll-mt-20">
              ...
              <div className="space-y-6">
                {commands.map((cmd, idx) => (
                  <div
                    key={idx}
                    className="bg-[#1a1629]/90 border border-gray-700/30 rounded-xl p-6 hover:border-[#ff006e]/50 transition-all"
                  >
            ...
            <section id="workflow" className="scroll-mt-20">
              ...
              <p className="text-gray-300 mb-4">A typical workflow using JVCS:</p>
              <SyntaxHighlighter language="bash" style={tomorrow}>
{`# 1. Authenticate
jvcs begin
...
jvcs log`}
            ...
            <section id="faq" className="scroll-mt-20">
              ...
              <div className="space-y-4">
                <p className="text-gray-300">Common questions about JVCS commands and usage.</p>
              </div>
            </section>
          </div>
        </div>
