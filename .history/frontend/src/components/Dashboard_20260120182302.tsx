  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0d0221] via-[#1a1629] to-[#0d0221] text-gray-200">
      ...
      <div className="max-w-7xl mx-auto px-6 py-10 space-y-10">
        ...
        <section className="bg-[#1a1629]/90 backdrop-blur-xl border border-[#00d9ff]/30 rounded-none p-8 shadow-2xl transition-all duration-300">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="p-6 bg-[#0d0221]/60 border border-[#ff006e]/20">
              ...
              {userRepo.length === 0 ? (
                <p className="text-gray-400">No repos yet. Create one to get started.</p>
              ) : (
                userRepo
                  .slice()
                  ...
                  .map((repo) => (
                    <div
                      ...
                      className="p-4 border border-[#ff006e]/20 mb-3 cursor-pointer hover:bg-[#ff006e]/10 transition-all"
                    >
            ...
            <div className="p-6 bg-[#0d0221]/60 border border-[#00d9ff]/20">
              <h3 className="text-lg font-bold text-gray-100 mb-4">Community Highlights</h3>

              <div className="p-4 border border-[#00d9ff]/20 mb-3">
                <p className="text-xs text-gray-400">Most Starred Public Repo</p>
              ...
              <div className="p-4 border border-[#00d9ff]/20">
                <p className="text-xs text-gray-400">Most Followed Profile</p>
                <p className="font-semibold text-gray-100">
                  {publicProfiles
                    .slice()
                    .sort(
        ...
        {/* My Repositories */}
        <section className="bg-[#1a1629]/90 backdrop-blur-xl border border-[#ff006e]/30 rounded-none p-8 shadow-2xl hover:shadow-[0_0_50px_rgba(255,0,110,0.15)] transition-all duration-300">
        ...
        <section className="bg-[#1a1629]/90 backdrop-blur-xl border border-[#00d9ff]/30 rounded-none p-8 shadow-2xl hover:shadow-[0_0_50px_rgba(0,217,255,0.15)] transition-all duration-300">
          <div className="flex items-center gap-3 mb-6">
        ...
        <section className="bg-gradient-to-r from-[#1a1629]/90 to-[#0d0221]/90 backdrop-blur-xl border border-[#ffbe0b]/30 rounded-none p-8 shadow-2xl hover:shadow-[0_0_50px_rgba(255,190,11,0.15)] transition-all duration-300 text-center">
          <div className="flex items-center justify-center gap-3 mb-4">
            <div className="p-2 bg-gradient-to-br from-[#ffbe0b]/20 to-[#ff006e]/20 rounded-none">
