...
//             </section> */}
            ...
            <section id="faq" className="scroll-mt-20">
              ...
              <div className="space-y-4">
                {[
                  ...
                  {
                    q: "Can I move to a specific commit?",
                    a: "Yes, use 'jvcs revert' to move to specifc commits. You can choose which commits to revert.",
                  },
                  {
            ...
            {/* Pro Tips */}
            <section className="bg-gradient-to-r from-[#ff006e]/15 via-[#00d9ff]/10 to-[#ffbe0b]/15 border border-[#ffbe0b]/50 rounded-2xl p-8 shadow-lg shadow-[#ffbe0b]/10">
              <h3 className="text-2xl font-bold text-[#ffbe0b] mb-6 flex items-center gap-3">
                <Zap className="w-7 h-7" />
                Pro Tips
              </h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  "Use descriptive commit messages for better history",
                  "Run 'jvcs status' frequently to track changes",
                  "Push regularly to backup your work remotely",
                  "Explore public repositories to learn from others",
                  "Make projects public to share with community",
                  "Use meaningful branch and repo names",
                ].map((tip, idx) => (
                  <div key={idx} className="flex items-start gap-3 p-3 rounded-lg hover:bg-white/5 transition-colors">
                    <span className="text-[#ffbe0b] font-bold text-lg mt-0.5">✓</span>
