  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0d0221] via-[#1a1629] to-[#0d0221] text-gray-200">
      ...
      <div className="max-w-7xl mx-auto px-6 py-10 space-y-10">
        {/* My Repositories */}
        <section className="bg-[#111217] border border-[#1f2029] rounded-2xl p-8 shadow-lg shadow-[#00ffd533]">
          <div className="flex items-center gap-2 mb-6">
            <GitBranch className="w-6 h-6 text-[#00ffd5]" />
            <h2 className="text-2xl font-bold text-[#00ffd5]">My Repositories</h2>
          </div>
              ...
              {userRepo.map((repo) => (
                ...
                >
                  <div className="flex items-start justify-between mb-2">
                    <h3 className="font-semibold text-[#00ffd5] hover:underline">{repo.name}</h3>
                    <span className="text-xs px-2 py-1 bg-[#0a0b0f] text-gray-400 rounded-full border border-[#1f2029]">
                      {repo.visibility}
                    </span>
                  </div>
        ...
        <section className="bg-[#111217] border border-[#1f2029] rounded-2xl p-8 shadow-lg shadow-[#00ffd533]">
          <div className="flex items-center gap-2 mb-6">
            <Users className="w-6 h-6 text-[#00ffd5]" />
            <h2 className="text-2xl font-bold text-[#00ffd5]">Public Repositories</h2>
          </div>
