    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0d0221] via-[#1a1629] to-[#0d0221] text-gray-200 flex flex-col">
      ...
      <main className="flex-1 max-w-6xl mx-auto w-full px-4 sm:px-6 py-10 space-y-8">
        ...
        {showModal && selectedFile && (
          <div
            className="fixed inset-0 z-[999999] flex flex-col bg-[#0b0c10] text-white overflow-hidden"
            aria-modal="true"
            role="dialog"
          >
            {/* Header */}
            <div className="sticky top-0 flex justify-between items-center px-4 sm:px-6 py-3 border-b border-[#1f2029] bg-[#0f1114]/95">
            ...
            <div className="flex-1 overflow-auto p-3 sm:p-6">
              ...
              <div className="border border-[#1f2029] bg-[#0a0b0f] shadow-[0_0_24px_rgba(0,255,213,0.12)] p-3 sm:p-5 overflow-auto no-scrollbar">
                <SyntaxHighlighter
