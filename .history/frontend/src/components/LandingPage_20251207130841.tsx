...
jvcs push`}
          ...
          <div className="bg-[#1a1629]/90 backdrop-blur border border-[#00d9ff]/30 rounded-xl p-8">
            ...
            <p className="text-gray-400 mb-6">Install JVCS locally in your project. Useful for team projects and CI/CD pipelines.</p>
...
# Create some files
echo "console.log('Hello JVCS');" > index.js
