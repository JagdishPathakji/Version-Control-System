    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0d0221] via-[#1a1629] to-[#0d0221] text-gray-200">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          {/* Sidebar */}
          <div
            className={`${sidebarOpen ? "block" : "hidden lg:block"} lg:col-span-1`}
          >
          ...
          <div className="lg:col-span-4 space-y-12">
            ...
            <section id="installation" className="scroll-mt-20 space-y-6">
              ...
              {[
                ...
                <div
                  key={idx}
                  className="bg-[#0d0221] border border-[#ff006e]/40 rounded-2xl p-6 shadow-md hover:shadow-lg transition-all"
                >
                  ...
                  <div className="relative mb-2">
                    ...
                    <button
                      ...
                      className="absolute top-4 right-4 p-2.5 hover:bg-[#ff006e]/20 rounded-lg transition-all"
                    >
                      {copied === `install-${idx}` ? (
                ...
                >
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <button
                      ...
                      className="p-2 bg-[#ff006e]/20 rounded-lg hover:bg-[#ff006e]/40 transition-colors"
                    >
                      {copied === `cmd-${idx}` ? (
