...
export default function Documentation({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#05020f] via-[#0b0718] to-[#05020f] text-gray-200">
      {/* Navbar */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 bg-[rgba(255,0,110,0.10)] border border-[rgba(255,0,110,0.35)] backdrop-blur-md p-6">
                  ...
                  <button
                    ...
                    className={`w-full text-left px-4 py-3 transition-all duration-200 flex items-center gap-3 ${
                      activeSection === section.id
                        ? "bg-[rgba(255,0,110,0.35)] text-white border border-[rgba(255,0,110,0.35)]"
                        : "text-gray-300 hover:bg-[rgba(255,0,110,0.15)] hover:text-white"
                    }`}
                  >
          ...
          <div className="lg:col-span-4 space-y-12">
            ...
            <section id="installation" className="scroll-mt-20 space-y-6">
              ...
              {[
                ...
                <div
                  key={idx}
                  className="bg-[rgba(255,255,255,0.05)] border border-[rgba(255,255,255,0.08)] backdrop-blur-md p-6 shadow-md hover:shadow-lg transition-all"
                >
                  ...
                  <div className="relative mb-2">
                    ...
                    <button
                      ...
                      className="absolute top-4 right-4 p-2.5 hover:bg-[rgba(255,0,110,0.25)] transition-all"
                    >
                      {copied === `install-${idx}` ? (
                ...
                >
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <button
                      ...
                      className="p-2 bg-[rgba(255,0,110,0.15)] hover:bg-[rgba(255,0,110,0.25)] transition-colors"
                    >
                      {copied === `cmd-${idx}` ? (
            ...
            <section id="workflow" className="scroll-mt-20 space-y-6">
              ...
              <div className="bg-[rgba(255,255,255,0.04)] border border-[rgba(255,255,255,0.08)] p-6 overflow-x-auto">
                <SyntaxHighlighter
                  language="bash"
                  style={tomorrow}
                  customStyle={{
