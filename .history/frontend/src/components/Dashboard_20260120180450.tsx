    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-[#0d0221] via-[#1a1629] to-[#0d0221] text-gray-200">
        ...
        <div className="max-w-7xl mx-auto px-6 py-10 space-y-10">
          {/* Welcome Section */}
          <section className="bg-[#1a1629]/90 backdrop-blur-xl border border-[#ff006e]/30 p-8 shadow-2xl hover:shadow-[0_0_50px_rgba(255,0,110,0.15)] transition-all duration-300">
            <div className="flex items-center justify-between gap-4">
              <div>
                ...
                <p className="text-gray-400 mt-2">
                  Your workspace is ready. Explore repositories, profiles and
                  discover public projects.
                </p>
              </div>

              <div className="flex gap-3">
                <div className="p-3 bg-[#0d0221]/60 border border-[#ff006e]/20">
                  <p className="text-xs text-gray-400">My Repos</p>
                  <p className="text-xl font-bold text-gray-100">
                    {userRepo.length}
                  </p>
                </div>
                <div className="p-3 bg-[#0d0221]/60 border border-[#00d9ff]/20">
                  <p className="text-xs text-gray-400">Public Repos</p>
                  <p className="text-xl font-bold text-gray-100">
                    {publicRepos.length}
                  </p>
                </div>
                <div className="p-3 bg-[#0d0221]/60 border border-[#ffbe0b]/20">
          ...
          {/* Public Repositories */}
          <section className="bg-[#1a1629]/90 backdrop-blur-xl border border-[#00d9ff]/30 p-8 shadow-2xl hover:shadow-[0_0_50px_rgba(0,217,255,0.15)] transition-all duration-300">
            <div className="flex items-center gap-3 mb-6">
          ...
          <section className="bg-gradient-to-r from-[#1a1629]/90 to-[#0d0221]/90 backdrop-blur-xl border border-[#ffbe0b]/30 p-8 shadow-2xl hover:shadow-[0_0_50px_rgba(255,190,11,0.15)] transition-all duration-300 text-center">
