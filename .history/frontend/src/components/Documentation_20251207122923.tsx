...
import { ArrowLeft, Code, GitBranch, Zap, Copy, Check, BookOpen } from "lucide-react";
...
export default function Documentation({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0d0221] via-[#1a1629] to-[#0d0221] text-gray-200">
      {/* Header */}
      <div className="sticky top-0 z-40 backdrop-blur-xl border-b border-[#ff006e]/20 bg-[#0d0221]/80">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-4">
            <button
              onClick={() => navigate(-1)}
              className="p-2 hover:bg-[#ff006e]/10 rounded-lg transition-colors"
            >
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 bg-[#1a1629]/90 backdrop-blur border border-[#ff006e]/30 rounded-xl p-6 space-y-3">
              <h3 className="text-sm font-semibold text-[#ff006e] uppercase tracking-wider">Menu</h3>
              <nav className="space-y-2">
                {[
                  ...
                  <button
                    ...
                    className="w-full text-left px-3 py-2 rounded-lg text-sm text-gray-400 hover:bg-[#ff006e]/10 hover:text-[#ff006e] transition-colors"
                  >
                    {item.label}
                  </button>
                ))}
